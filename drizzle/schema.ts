...
export const notificationType = pgEnum("notification_type", ['like', 'comment', 'follow', 'badge', 'study_session', 'friend_request', 'friend_accept', 'friend_reject', 'message', 'friend_post'])
